  ...
  const messages: UIMessage[] = [
    {
      ...
      parts: [
        { type: "text", text: "Creating your component..." },
        {
          ...
          input: { command: "delete", path: "/test.jsx" },
          output: "Success",
        },
      ],
    },
...
test("MessageList shows content and loading indicator for streaming assistant message", () => {
  const messages: UIMessage[] = [
    {
      id: "1",
      role: "assistant",
  ...
  // The component shows partial content AND a loading indicator while streaming
